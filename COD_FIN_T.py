...
for device in devices:
    ...
    output_11 = net_connect.send_command("show ip interface brief")
    output_12 = net_connect.send_command("show int Bundle-Ether2000")
    output_13 = net_connect.send_command("show interface TenGigE0/2/0/0")
    output_14 = net_connect.send_command("show processes cpu")
    output_15 = net_connect.send_command("show processes memory")
...
def create_file(): 
    ...
    with open(documento.strftime("%d %B %Y- Hora_%H-%M-%S" )+".txt", "w") as documentacion: 
        ...
        documentacion.write("-"*100)
        documentacion.write("\n")
        documentacion.write("================show ip interface brief===============================================")
        documentacion.write("\n")
        documentacion.write(output_11)

        documentacion.write("\n")
        documentacion.write("-"*100)
        documentacion.write("\n")
        documentacion.write("================show int Bundle-Ether2000===============================================")
        documentacion.write("\n")
        documentacion.write(output_12)

        documentacion.write("\n")
        documentacion.write("-"*100)
        documentacion.write("\n")
        documentacion.write("================show interface TenGigE0/2/0/0===============================================")
        documentacion.write("\n")
        documentacion.write(output_13)

        documentacion.write("\n")
        documentacion.write("-"*100)
        documentacion.write("\n")
        documentacion.write("================show processes cpu===============================================")
        documentacion.write("\n")
        documentacion.write(output_14)

        documentacion.write("\n")
        documentacion.write("-"*100)
        documentacion.write("\n")
        documentacion.write("================show processes memory===============================================")
        documentacion.write("\n")
        documentacion.write(output_15)
